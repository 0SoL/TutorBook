...
from .views import student_register, student_profile, student_profile_creation, booking_list, student_edit_profile,review_form
...
urlpatterns = [
    ...
    path('review/<int:teacher_id>/', review_form, name='review-teacher')
]
